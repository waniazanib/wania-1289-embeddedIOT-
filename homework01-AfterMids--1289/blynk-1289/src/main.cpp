...
#define BLYNK_TEMPLATE_ID "TMPL6kgCT_DG-"
#define BLYNK_TEMPLATE_NAME "assignment 1289"
#define BLYNK_AUTH_TOKEN    "0hcyuKWRgeaZHwgpwj4_AumNTo2Hkh6R"  // <-- from Blynk device_hLmtVUUWlhtBanXKpviBJt0D_zIBJsA
